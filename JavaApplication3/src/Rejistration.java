 ...
 */
public class Rejistration extends javax.swing.JFrame {

    /**
     * Creates new form Rejistration
     */
    public Rejistration() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(100, 30, 120, 50);
        ...
        jButton2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.white, java.awt.Color.lightGray, java.awt.Color.white, java.awt.Color.white));
        jPanel1.add(jButton2);
        jButton2.setBounds(80, 340, 140, 33);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rejistration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rejistration().setVisible(true);
            }
        });
    }
